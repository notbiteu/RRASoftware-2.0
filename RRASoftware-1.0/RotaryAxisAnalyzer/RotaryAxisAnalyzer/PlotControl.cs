...
namespace RotaryAxisAnalyzer
{
    public partial class PlotControl : UserControl
    {
        ...
        public PlotControl()
        {
            ...
            machinfoBtn.Image = Properties.Resources.computerized_b;
        ...
        {
            machinfoBtn.Image = Properties.Resources.computerized_b;
            testInfoBtn.Image = Properties.Resources.infomation;
        ...
        {
            machinfoBtn.Image = Properties.Resources.computerized;
            testInfoBtn.Image = Properties.Resources.infomation_b;
...
-5.59E-01
        ...
        private void saveTestBtn_Click(object sender, EventArgs e)
        {
            ...
            // Get values from the testInfoPage form
            var title = testinfo.GetTestTitle();
            var opName = testinfo.GetOperatorName();
            var note_x = testinfo.GetNotes();

            var machName = machinfo.GetMachName();
            var SNumMach = machinfo.GetSNumMach();
            var axis = machinfo.GetAxis();
            var machManuf = machinfo.GetMachManuf();
            var custName = machinfo.GetCustName();
            var compName = machinfo.GetCompName();
            var machAddress = machinfo.GetMachAddress();
            ...
            var custcoll = database.GetCollection<BsonDocument>("customerDetails");
            //var datageez = new List<MeasurementDetails>();
        ...
        {"serialNumberMachine", SNumMach},
        {"Axis", axis},
        {"MachManufacturer", machManuf}
    };
